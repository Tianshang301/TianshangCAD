...
def cmd_view3d(
    ...
    from cad_mcp_server.mcp.tools.view3d import (
        ViewRenderInput,
        cad_view_3d_render,
    )
    from cad_mcp_server.schemas.view3d import NAMED_VIEWS, named_view
...
def cmd_section(
    ...
    from cad_mcp_server.mcp.tools.view3d import ViewSectionInput, cad_view_section
...
def cmd_explode(
    ...
    from cad_mcp_server.mcp.tools.view3d import ViewExplodeInput, cad_view_explode
...
def cmd_gif(
    ...
    from cad_mcp_server.mcp.tools.view3d import ViewAnimationInput, cad_view_animation
...
def cmd_views() -> None:
    ...
    from cad_mcp_server.mcp.tools.view3d import ViewListInput, cad_view_3d_list
