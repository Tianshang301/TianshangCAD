...
from tianshangcad.core.style_manager import StyleManager
from tianshangcad.core.variables import VariableManager
from tianshangcad.core.view_manager import ViewManager
from tianshangcad.utils.errors import CADImportError, DocumentError
from tianshangcad.utils.units import validate_unit
...
class DocumentState:
    ...
    def from_dict(cls, data: dict[str, Any], path: Path | None = None) -> DocumentState:
        ...
        for view_data in data.get("views", []):
            from tianshangcad.schemas.view3d import View3DDefinition
