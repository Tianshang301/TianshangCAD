...
class Settings(BaseSettings):
    ...
    temp_dir: str = Field("/tmp/tianshangcad", description="Temporary file directory")  # noqa: S108
    ...
    config_path: str = Field("~/.tianshangcad/config.yaml", description="Config file path")
